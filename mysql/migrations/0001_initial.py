# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-01-09 02:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_finished', models.IntegerField(choices=[(0, 'unfinished'), (1, 'finished')], default=0, verbose_name='完成时间')),
                ('applyer_name', models.CharField(blank=True, max_length=30, verbose_name='申请人')),
            ],
            options={
                'verbose_name': '脚本',
